...
<div id="main">
  <form action="registerteam.php" method="POST">
  
  <p class="fontst" align="left">&nbsp; &nbsp; &nbsp;<font size="4"><b>Register your Team</b></font></p>
  ...
  <table style="width: 90%; text-align: center;" class="tabel fontst" align="center">
     ...
     <tr>
      ...
      <td align="center" width="25%">
       <input value="" name="tag" type="text">
      </td>
      <td align="center" width="25%">
       <input value="" name="link" type="text">
      </td>
      <td align="center" width="25%" rowspan="2">
       <input value="Register" name="score2" type="submit">
      </td>
     </tr>
     <tr>
      <td colspan="3">
       <input type="text" placeholder="Put here the link of your clan's logo" name="logo" style="margin: 4px; width: 60%;"/>
      </td>
     </tr>
    </table>
    ...
    <table class="tabel2 fontst" style="width: 90%;" align="center">
     <tr>
      <td width="100%">
       Filling this form, you will be able to add your clan in our database and start gaining points by posting wars you play. Your team won't be added directly because we will check the information before let you join.
       <b>Note</b> that when you click 'Register' and you will be redirected to the Home Page, it means that your data has been successfully sent.
      </td> 
     </tr>
    </table> 
