...
<div id="main">
 ...
 ?>
      ...
      <td width="33%" align="center">
       <a href="rankings.php"><input type="button" value="Players Rankings" /></a>
      </td>
     </tr>
    </table> 
 ...
 <div class="mincont">
  ...
  <?php
   ...
   $result = mysqli_query($con,"SELECT * FROM players WHERE `clan` = '".$_GET['id']."' AND `gp` >= 3 ORDER BY `clan` ASC");
