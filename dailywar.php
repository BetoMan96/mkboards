  ...
  <div id="contorno">
    ...
    <table style="width: 90%; text-align: center;" align="center" class="tabel fontst">
     <tr>
      ...
      <td width="25%" align="center">
       <input type="button" value="War Archive" onclick="location.href='warslist.php'" />
      </td>
     </tr>
    </table>    
  <?php
   ...
   echo "<br><br>
    ...
    <table style=\"width: 100%; text-align: center;\" align=\"left\" class=\"tabel fontst\">
     ...
     $cas = mysqli_query($con,"SELECT * FROM clanwars WHERE date = '".$_GET['date']."' ORDER BY date DESC");
     ...
     <input type=\"text\" id=\"diocane\" value=\"".$x."\" style=\"display: none; visibility: hidden;\" readonly />";
 ?>
 </div>
